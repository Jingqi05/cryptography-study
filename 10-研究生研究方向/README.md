...
| 会议 | 热门主题 |
|------|---------|
| CRYPTO/EUROCRYPT | 格密码新构造、FHE 效率突破、ZKP 递归组合 |
| ASIACRYPT | 后量子迁移方案、隐私计算协议优化 |
| IEEE S&P/CCS | 侧信道新攻击方法、AI 安全与对抗 |
| USENIX Security/NDSS | 协议形式化验证、实际系统安全分析 |

## 研究生选题建议

| 方向 | 选题示例 |
|------|---------|
| PQC 工程 | ML-KEM 在嵌入式平台的高效实现 |
| ZKP 应用 | 基于 zk-SNARK 的身份匿名认证系统 |
| FHE 优化 | CKKS 方案的 GPU 加速实现 |
| 侧信道 | 基于深度学习的功耗分析攻击 |
| MPC 协议 | 隐私保护集合求交（PSI）协议优化 |
| AI+Crypto | 联邦学习中的差分隐私保护机制 |
| 国密工程 | SM2/SM3/SM4 在 TLS 1.3 中的集成 |
